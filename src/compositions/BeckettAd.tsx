...
const SHOTS = [
  ...
  // the board — real state, #15 sitting in progress
  {
    ...
    el: (d: number) => (
      <Shot
        ...
        from={{ cx: 1920, cy: 600, z: 0.48 }}
        to={{ cx: 1850, cy: 540, z: 0.53 }}
        dur={d}
        label="the board"
  ...
  // the ticket, staffed
  {
    ...
    el: (d: number) => (
      <Shot
        ...
        from={{ cx: 3130, cy: 300, z: 1.3 }}
        to={{ cx: 3130, cy: 386, z: 1.3 }}
        dur={d}
        label="staffed"
  ...
  // its journal, live
  {
    ...
    el: (d: number) => (
      <Shot
        src="captures/ticket.png"
        from={{ cx: 3045, cy: 720, z: 1.15 }}
        to={{ cx: 3045, cy: 1520, z: 1.15 }}
        dur={d}
        label="journal · live"
  ...
  // a real fix, on a real commit
  {
    ...
    el: (d: number) => (
      <Shot
        ...
        from={{ cx: 1920, cy: 560, z: 0.78 }}
        to={{ cx: 1920, cy: 700, z: 0.78 }}
        dur={d}
        label="the fix"
  ...
  // shipped
  {
    ...
    el: (d: number) => (
      <Shot
        ...
        from={{ cx: 1920, cy: 600, z: 0.8 }}
        to={{ cx: 1920, cy: 764, z: 0.8 }}
        dur={d}
        label="shipped"
  ...
  // opened upstream
  {
    ...
    el: (d: number) => (
      <Shot
        ...
        from={{ cx: 1500, cy: 520, z: 0.72 }}
        to={{ cx: 1500, cy: 646, z: 0.72 }}
        dur={d}
        label="upstream"
  ...
  // merged
  {
    ...
    el: (d: number) => (
      <Shot
        ...
        from={{ cx: 1500, cy: 520, z: 0.75 }}
        to={{ cx: 1500, cy: 660, z: 0.75 }}
        dur={d}
        label="merged"
  ...
  // everything already done, flying past
  {
    ...
    el: (d: number) => (
      <Shot
        ...
        srcH={3254}
        from={{ cx: 1920, cy: 900, z: 0.55 }}
        to={{ cx: 1920, cy: 2320, z: 0.55 }}
        dur={d}
        label="12 done"
        refText="this week"
      />
  ...
  // the deploy, live
  {
    ...
    el: (d: number) => (
      <Shot
        src="captures/board.png"
        from={{ cx: 1200, cy: 250, z: 0.9 }}
        to={{ cx: 1350, cy: 250, z: 0.9 }}
        dur={d}
        label="live"
        refText="bored.0xbeckett.me"
      />
